...
const Timelineitem: React.FC<TimelineItemProps> = (props) => {
  return (
    <div className={`timeline-item relative grid gap-0 w-full pt-[140px] top-28 last:pb-0 
      grid-cols-[48px_1fr] max-sm:px-5 max-sm:pr-2.5
      sm:grid-cols-[64px_1fr]
      md:grid-cols-[minmax(0,1fr)_120px_minmax(0,1fr)] md:py-[80px] md:w-auto
      xl:grid-cols-[1fr_180px_1fr] xl:py-[100px]
      ti-${props.number}`}
    >
      ...
      >
        ...
        >
          ...
          <div className="timeline-step-number-text relative text-white uppercase font-['Oswald'] font-medium leading-[1.2] z-2
            mb-6 text-left max-sm:text-[1.8em] max-sm:leading-[1.4]
            sm:text-[2em]
            md:mb-0 md:text-[2.5em] md:text-right md:sticky md:top-[47.5vh]
            xl:text-[4em]"
          >
            {props.step}
          </div>
          ...
          <div className="timeline-step-number absolute block z-[1] font-['Oswald'] font-medium
            ...
            max-sm:top-[-407%] max-sm:left-[-1%] max-sm:text-[6em] max-sm:leading-[1]
      ...
      <div className="timeline-right pb-5">
        {/* Heading */}
        <div className="timeline-heading text-left mb-5 text-white font-['Nulshock'] font-semibold leading-[1.3]
        ...
        {/* Description */}
        <div className="timeline-description text-left w-full mt-5 leading-relaxed text-[#afafaf]
          max-sm:mb-5 max-sm:text-[0.9rem]
          sm:mb-12
